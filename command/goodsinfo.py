...
'''
goodsinfo 會員功能，個股技術指標情況
'''
class MyWatchStock(command_base.BaseCommand):
    def __init__(self):
        self.prefix = "goodsinfo"
        self.how_to_use = f'goodsinfo'
    ...
    # 覆写父类的方法
    def process(self, params):
        return stock_parse.parseMyWatchStock()